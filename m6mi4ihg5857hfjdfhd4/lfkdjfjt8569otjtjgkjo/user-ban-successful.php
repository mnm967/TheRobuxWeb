        ...
        <div class="card card-nav-tabs text-center" style="margin-bottom: 0; padding-bottom: 16px">
          <div class="card-body">
            <div class="col-md-12">
              ...
              <h3 class="card-title" style="color: #d50000; width: 100%; text-align: center;">User Banned</h3>
              <h4 class="card-text" style="color: #d50000; width: 100%; text-align: center;">User Successfuly Banned.</h4>
