        ...
        <div class="card card-nav-tabs text-center" style="margin-bottom: 0; padding-bottom: 16px">
          <div class="card-body">
            <div class="col-md-12">
              ...
              <h3 class="card-title" style="color: #4CAF50; width: 100%; text-align: center;">Changes Saved Successful</h3>
              <h4 class="card-text" style="color: #4CAF50; width: 100%; text-align: center;">Your Changes were Saved Successfully.</h4>
              <a href="admin-dashboard.php" class="card-text" style="width: 100%; text-align: center;">View Dashboard</a>
            </div>
          </div>
        </div>
      </div>
